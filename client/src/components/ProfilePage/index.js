            ...
            <div className="col-1g-10">
                <div className="row">
                    ...
                    <div className="mx-auto">
                        <button className="profile-buttons" ><i className="fas fa-plus"></i></button>
                        <button className="profile-buttons"><i className="fas fa-user"></i></button>
                        <button className="profile-buttons"><i className="fas fa-shopping-bag"></i></button>
                        </div>
                    </div>
